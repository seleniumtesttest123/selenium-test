...
drop_month=Select(driver.find_element(By.XPATH,"//select[@aria-label='Select year']"))
...
ddrop_month=Select(driver.find_element(By.XPATH,"//select[@aria-label='Select month']"))
ddrop_month.select_by_visible_text("Jun")
ddrop_year=Select(driver.find_element(By.XPATH,"//select[@aria-label='Select year']"))
ddrop_year.select_by_visible_text("2025")
ddates=driver.find_elements(By.XPATH,"//div[@id='ui-datepicker-div']//table/tbody/tr/td/a")
for dd in ddates:
    if dd.text=="5":
        dd.click()
        break
...
driver.find_element(By.XPATH,"//span[@aria-label='State / District / Province']").click()
